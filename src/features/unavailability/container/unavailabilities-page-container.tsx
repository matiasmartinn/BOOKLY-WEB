...
export function UnavailabilitiesPageContainer() {
  ...
  const handleDelete = () => {
    ...
    removeMutation.mutate(selectedUnavailability.id, {
      onSuccess: () => {
        handleCloseDelete();
    ...
    <>
      <Stack gap="md">
        <Group justify="flex-end">
          <Button onClick={createHandlers.open} disabled={!selectedService}>
            Agregar excepcion
          </Button>
        </Group>
